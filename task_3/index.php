...
<div class="column_left">
	<div class="header ml-3 mt-3">
		<div class="logo"></div>
		<div class="mt-1 mr-3 ">
			<a class="no_dec" href="#">
				<p3 class="ml-1 mr-1" href="#">About</p3>
			</a>
			<a class="no_dec" href="#">
				<p3 class="ml-1 mr-1" href="#">How it works</p3>
			</a>
			<a class="no_dec" href="#">
				<p3 class="ml-1" href="#">Contact</p3>
			</a>
		</div>
	</div>
	...
	<div class="content mt-5">
		...
		<p2>Subscribe to our newsletter and get 10% discount on pineapple glasses.</p2>
		<div class="buttonInside mt-2" >
				<input class="email" name="email" id="email" type="text" placeholder="Type your email adress here..." ><input id="s_button" name="submit" value="" class="e_button" type="submit">
				<pr id="warning">
					<?php
					if(isset($_POST['email'])){
						...
						if($error){
							...
							$test=$pdo->prepare("insert into emails (email) VALUES (?)")->execute([$email]);
							echo '<script>window.location="http://localhost/task_3/success.php"</script>';
						}
					}
					?>
				</pr>
		...
		<label class="container">
			...
			<input id="checkbox" name="terms" type="checkbox" checked onchange="validate()">
	...
	<div class="social mt-2">
		...
		<div>
			<a class="no_dec " href="#">
				<svg class="instagram" width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
					<circle cx="23" cy="23" r="22" stroke="#E2E3E4" stroke-width="2" />
		...
		<div>
			<a class="no_dec " href="#">
				<svg class="twitter" width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
					<circle cx="23" cy="23" r="22" stroke="#E2E3E4" stroke-width="2" />
		...
		<div>
			<a class="no_dec" href="#">
				<svg class="youtube" width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
					<circle cx="23" cy="23" r="22" stroke="#E2E3E4" stroke-width="2" />
